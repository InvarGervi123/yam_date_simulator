// --- Story Chapter: COURT (Ace Attorney Phoenix Wright Parody - הרב ינוור בייט נגד ים שמואל) ---
Object.assign(window.story, {
  ...
  court_check_evidence_intro: {
    ...
    bg: "images/backgrounds/בית משפט.png",
    character: "images/characters/ינוור החרדי.png",
    text: "ינוור פותח את תיק המוצגים (Court Record):\n'שולחתי היקרה, הכנתי עבורנו את כל הראיות: דוח אנליטיקס 2024, יומן שעות השינה, שטר משלוח הבורקס וחוזה המיטה! בכל רגע תוכלי ללחוץ על הכפתור למעלה ולהציג ראיה!'",
    choices: [
      { text: "מעולה, בוא נפתח בחקירה הנגדית!", next: "court_act1_cross_exam" }
    ]
  },
  ...
  court_act1_present_menu: {
    ...
    bg: "images/backgrounds/בית משפט.png",
    character: "images/characters/ינוור החרדי.png",
    text: "בחר איזו ראיה ברצונך להטיח בנאשם כדי להפריך את טענת 18 שעות העריכה:",
    choices: [
      {
  ...
  court_act2_present_menu: {
    ...
    bg: "images/backgrounds/בית משפט.png",
    character: "images/characters/ינוור החרדי.png",
    text: "בחר איזו ראיה ברצונך להציג כדי לנפץ את טענת הסכם השינה המזויף:",
    choices: [
      {
  ...
  court_act3_present_menu: {
    ...
    bg: "images/backgrounds/בית משפט.png",
    character: "images/characters/ינוור החרדי.png",
    text: "בחר את הראיה שתמוטט לחלוטין את טענת ריבונות המיטה:",
    choices: [
      {
