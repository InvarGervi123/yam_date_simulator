...
Object.assign(window.story, {
  ...
  // ==========================================
  // תפריט בחירת תיקים ופרקים (Case Select Menu)
  // ==========================================
  court_menu: {
    speaker: "בית הדין הגדול (Ace Attorney - בחירת תיק)",
    music: "audio/פיניקס בייט_ הסנגור לענייני קלוריות.mp3",
    bg: "images/backgrounds/בית משפט.png",
    character: false,
    text: "🏛️ **בית דין צדק לענייני שדים, דייטים ויוטיוב — בחירת תיק משפטי:**\n\nברוכים הבאים להיכל הצדק! בחר את התיק שברצונך לחקור ולשפוט:",
    onEnter: function() {
    ...
    choices: [
      { text: "📜 תיק 1: דין תורה — תביעת ליליה והרב ינוור בייט נגד ים (אליבי המיטה והעריכה)", next: "court_intro" },
      { text: "🔥 תיק 2: התביעה הנגדית של ים נגד ליליה (סודות השאול וברית 2019)", next: "court_ch2_intro" },
      { text: "🔙 חזרה לחדר של ים", next: "room_intro" }
    ]
  },

  // ==========================================
  // פרק 1 - פרולוג: פתיחת בית הדין וחשיפת השדה ליליה
  // ==========================================
  court_intro: {
    ...
    choices: [
      ...
      { text: "🔙 חזרה לתפריט התיקים", next: "court_menu" }
    ]
  },
