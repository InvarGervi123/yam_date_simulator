...
Object.assign(window.story, {
  ...
  game_info_scene: {
    speaker: "מדריך המשחק (System Manual)",
    text: "📢 עדכון גרסה אחרון (PWA Offline v2.0):\n• מפתח ראשי ומהנדס מערכת גאון: ינוור (InvarGervi123)\n• קוד המקור הרשמי של המשחק זמין ב-GitHub:\n  https://github.com/InvarGervi123/yam_date_simulator\n\n💻 מידע טכנולוגי:\n• המשחק תומך במצב אופליין מלא - ניתן להתקין דרך הדפדפן (Add to Home screen) והמשחק יעבוד ללא אינטרנט!\n• תאימות: מותאם ב-100% למחשבים (PC/Laptop) וניידים (iOS/Android).\n\n⌨️ מקשי מקלדת ללפטופים (ללא עכבר):\n• רווח (Space) / אנטר: המשך דיאלוג.\n• מקשים 1-9: בחירת אפשרויות בסיפור ובקרב.\n• בקרב הבוס: מקשים 1-4 לתפריט הראשי, Backspace/Escape לסגירת תת-תפריט.",
    choices: [
      { text: "מעולה, בוא נתחיל במשחק!", next: "room_intro" },
